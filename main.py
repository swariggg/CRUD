...
class SalidaUsuario(BaseModel):
    ...
    correo: str
    activa: bool
    #base de datos quemada o donde esta la que se va a descubrir
usuarios = [
    {"id": 1, "usuario": "camila", "correo": "camilasolvin@gmail.com", "password": "abc", "activa": True},
]

#crea el usuario, por eso "post"
...
def crear_usuario(u: UsuarioNuevo):
    ...
    # salida de usuario (sin password)
    return {"id": user["id"], "usuario": user["usuario"], "correo": user["correo"], "activa": user["activa"]}

# lista usuarios, se usa get por que vamos a obtener info o algo asi
...
# se usa get para conseguir el usuario pero usamos solo el id
...
# con el put podemos actualizar la info del usauri
